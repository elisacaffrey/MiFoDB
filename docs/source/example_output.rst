...
1. Your inStrain profile results (ex. EBC_177.IS_genome_info.csv)

.. csv-table:: EBC_177.IS_genome_info.csv
...
2. Sample read info, found in bowtie2.log file created after . 
